...
external_url 'https://git.qh-1.cn'
...
#用户登录密码
gitlab_rails['smtp_password'] = "keypassword"
#SMTP 服务器主域
...
gitlab_rails['ldap_servers'] = YAML.load <<-'EOS'
   main: # 'main' is the GitLab 'provider ID' of this LDAP server
     ...
     port: 389
     uid: 'cn'
     bind_dn: 'cn=admin,dc=qh-1,dc=cn'
     password: 'password'
...
nginx['ssl_certificate'] = "/etc/gitlab/ssl/1_git.qh-1.cn_bundle.crt"
nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/2_git.qh-1.cn.key"
